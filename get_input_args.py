...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg', help='select a model')
    parser.add_argument('--dogfile', type=str, default='dognames.txt', help='a text file with dognames in it')
